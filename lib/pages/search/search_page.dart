...
class _SearchPageState extends State<SearchPage> {
  ...
  List<Widget> buildFilterChips() {
    ...
    if (filterState.sort != 'heat') {
      chips.add(InputChip(
        label: Text('Sort: ${_sortLabel(filterState.sort)}'),
    ...
    if (filterState.season.isNotEmpty) {
      chips.add(InputChip(
        label: Text('Season: ${filterState.season}'),
        onDeleted: () => _applyFilterState(
    ...
    if (filterState.rankRange?.isValid == true) {
      chips.add(InputChip(
        label: Text('Rank: ${filterState.rankRange!.toToken()}'),
        onDeleted: () => _applyFilterState(
    ...
    if (filterState.scoreRange?.isValid == true) {
      chips.add(InputChip(
        label: Text('Rating: ${filterState.scoreRange!.toToken()}'),
        onDeleted: () => _applyFilterState(
    ...
    if (filterState.weekdays.isNotEmpty) {
      chips.add(InputChip(
        label: Text('Weekday: ${filterState.weekdays.join(',')}'),
        onDeleted: () => _applyFilterState(
                    ...
                    builder: (context) {
                      if (controller.text.isNotEmpty) {
                        return const SizedBox(
                          height: 400,
                          child: Center(
                            child: Text("No suggestions, press Enter to search directly"),
                          ),
                        );
                      } else {
                        return Column(
      ...
      child: Column(
        children: [
          MaterialBottomSheetHeader(
            ...
            description: 'Combine tags, seasons, ratings, and other conditions to find what you want to watch faster.',
            ...
            child: ListView(
              ...
              children: [
                MaterialBottomSheetSection(
                  title: 'Sort',
                  description: 'Choose what to prioritize showing in the list.',
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SegmentedButton<String>(
                      ...
                      segments: const [
                        ButtonSegment(value: 'heat', label: Text('Popularity')),
                        ButtonSegment(value: 'rank', label: Text('Rank')),
                        ButtonSegment(value: 'score', label: Text('Rating')),
                ...
                MaterialBottomSheetSection(
                  title: 'Tags',
                  description: 'When multiple tags are selected, anime containing all of them are prioritized.',
                ...
                MaterialBottomSheetSection(
                  title: 'Season & Date',
                  description: 'Search by broadcast season, or specify a more precise date range.',
                          ...
                          children: [
                            ...
                            if (draft.season.isNotEmpty ||
                              ...
                              TextButton.icon(
                                ...
                                label: const Text('No Date Limit'),
                              ),
                          ],
                        ),
                      ),
                ...
                MaterialBottomSheetSection(
                  title: 'Value Range',
                  description: 'Only show anime that match the rating or ranking range.',
                  icon: Icons.tune_rounded,
                  child: Column(
                    children: [
                      _SearchSwitchTile(
                        title: 'Enable Rating Range',
                ...
                MaterialBottomSheetSection(
                  title: 'Weekday',
                  description: 'Filter by broadcast weekday; multiple weekdays match on any.',
                ...
                MaterialBottomSheetSection(
                  title: 'Filter',
                  description: 'Controls whether watched or dropped anime are hidden.',
