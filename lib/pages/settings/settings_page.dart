  ...
  _SettingsGroup(
    ...
    categories: [
      _SettingsCategory(
        ...
        description: 'Decoding, Rendering & Playback Behavior',
        icon: Icons.display_settings_rounded,
        builder: (_) => const PlayerSettingsPage(),
      ),
      _SettingsCategory(
        id: 'danmaku',
        label: 'Danmaku Settings',
        description: 'Danmaku Source & Display',
      ...
      _SettingsCategory(
        ...
        description: 'Player Key Mapping',
  ...
  _SettingsGroup(
    ...
    categories: [
      ...
      _SettingsCategory(
        ...
        description: 'Concurrency & Danmaku Cache',
  ...
  _SettingsGroup(
    ...
    categories: [
      ...
      _SettingsCategory(
        ...
        description: 'Splash Screen & Display Info',
      ...
      _SettingsCategory(
        id: 'sync',
        label: 'Sync Settings',
        description: 'Sync WebDAV with Bangumi',
  ...
  _SettingsGroup(
    ...
    categories: [
      _SettingsCategory(
        id: 'about',
        label: 'About',
        description: 'Version, Logs & Open Source Licenses',
