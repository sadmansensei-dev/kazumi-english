...
class _DownloadEpisodeSheetState extends State<DownloadEpisodeSheet> {
        ...
        return Column(
          children: [
            MaterialBottomSheetHeader(
              title: 'Select Episodes to Download',
              description: downloadedCount > 0
                  ? '$episodeCount episode(s) total · $downloadedCount added to download'
                  : '$episodeCount episode(s) total',
                  ...
                  children: [
                    FilledButton.tonalIcon(
                      ...
                      label: Stack(
                        ...
                        children: [
                          const Opacity(opacity: 0, child: Text('Deselect All')),
                    ...
                    Expanded(
                      child: FilledButton.icon(
                        ...
                        label: Text(_selectedEpisodes.isEmpty
                            ? 'Start Download'
                            : 'Download ${_selectedEpisodes.length} episode(s)'),
                      ),
                    ),
                  ],
                ),
  ...
  void _startBatchDownload(BuildContext context) {
    ...
    KazumiDialog.showToast(
      message: 'Added ${sortedEpisodes.length} episode(s) to the download queue, check Download Manager',
    );
  }
}
