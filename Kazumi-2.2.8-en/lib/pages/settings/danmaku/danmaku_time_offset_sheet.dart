...
String formatDanmakuTimeOffset(double value) {
  ...
  return '${value > 0 ? 'Delay' : 'Advance'} ${_formatDanmakuOffsetDuration(value)}';
}
...
class _DanmakuTimeOffsetSheetState extends State<DanmakuTimeOffsetSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final direction = _offset == 0 ? 'No Offset' : (_offset > 0 ? 'Delay' : 'Advance');
        ...
        body: Column(
          children: [
            MaterialBottomSheetHeader(
              title: 'Danmaku Timeline Offset',
              description: 'Calibrate danmaku display timing relative to the video',
                  ...
                  children: [
                      ...
                      builder: (context, constraints) {
                        final advanceButton = SizedBox(
                          ...
                          child: FilledButton.tonalIcon(
                            ...
                            label: const Text('Advance 1 sec'),
                          ),
                        );
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: const Text('Reset to No Offset'),
                      ),
                    ),
                  ],
                ),
