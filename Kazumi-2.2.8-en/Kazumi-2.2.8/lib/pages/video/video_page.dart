  ...
  bool sendDanmaku(String msg) {
    ...
    if (destination == DanmakuDestination.chatRoom) {
      if (playerController.syncplay.syncplayRoom.isEmpty) {
        KazumiDialog.showToast(message: "You haven't joined Watch Together yet, so you can't send chat danmaku");
        return false;
      }
          ...
          child: Column(
            ...
            children: [
              MaterialBottomSheetHeader(
                title: 'Send Danmaku To',
                description: "Choose where to send this danmaku",
                ...
                child: MaterialBottomSheetGroup(
                  ...
                  children: [
                    ListTile(
                      ...
                      subtitle: const Text('Visible to all Watch Together members'),
                    ...
                    ListTile(
                      ...
                      title: const Text('Send to Remote Danmaku Library'),
                      subtitle: const Text('Send as video danmaku'),
                      onTap: () => Navigator.of(context)
                              ...
                              children: [
                                ...
                                Text(
                                  videoPageController.loading
                                      ? 'Parsing video source'
                                      : 'Video source parsed successfully, loading player',
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      ...
                      child: Row(
                        children: [
                          Text(
                            danmakuOn ? '  Tap to send danmaku  ' : '  Danmaku off  ',
                            softWrap: false,
