...
class _TimelinePageState extends State<TimelinePage>
  ...
  Widget buildSeasonSheetHeader(BuildContext context) {
    ...
    return MaterialBottomSheetHeader(
      title: 'Time Machine',
      description: 'Jump back to any broadcast season; the timeline switches immediately.',
      ...
      child: Column(
        ...
        children: [
          ...
          if (!hasSelectedSeason) ...[
            ...
            Text(
              '${availableSeasons.length} season(s) available',
  ...
  Widget buildTimelineOptionsSheetHeader(BuildContext context) {
    return MaterialBottomSheetHeader(
      ...
      description: 'Adjust sorting and filter conditions; results apply immediately to the current timeline.',
      onClose: KazumiDialog.dismiss,
      footer: Observer(
        builder: (context) {
            ...
            children: [
              ...
              buildTimelineOptionSummaryChip(
                ...
                label: enabledFilterCount == 0
                    ? 'No filters enabled'
                    : '$enabledFilterCount filter(s) enabled',
  ...
  Widget showFilterSwitcher() {
    return MaterialBottomSheetSection(
      ...
      title: 'Filter',
      description: 'Collapse items you don\'t want shown by collection status; adjustable continuously.',
      child: Column(
        children: [
          Observer(
            builder: (context) => buildFilterOptionTile(
              ...
              description: 'Hide items marked as dropped.',
          ...
          Observer(
            builder: (context) => buildFilterOptionTile(
              ...
              description: 'Remove watched items from the timeline.',
          ...
          Observer(
            builder: (context) => buildFilterOptionTile(
              context,
              title: 'Only show anime being watched',
              description: 'Focus on items currently being tracked.',
      ...
      child: Column(
        children: [
          buildSortOptionTile(
            ...
            description: 'Prioritize showing items with higher discussion and interest levels.',
          ...
          buildSortOptionTile(
            ...
            description: 'Prioritize showing items with higher ratings.',
          ...
          buildSortOptionTile(
            ...
            sortType: 1,
            title: 'Sort by Time',
            description: 'Restore the default time order for viewing by broadcast schedule.',
