...
class _MyPageState extends State<MyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const SysAppBar(title: Text('Mine'), needTopOffset: false),
      body: SafeArea(
        top: false,
        bottom: false,
        child: Observer(
      ...
      children: [
        SettingsCategoryTile(
          ...
          description: stats.lastWatchName != null
              ? 'Last watched ${stats.lastWatchName}'
        ...
        SettingsCategoryTile(
          ...
          description: 'Cache Tasks & Local Files',
          onTap: () => context.pushNamed('/settings/download/'),
        ),
        SettingsCategoryTile(
          icon: Icons.settings_rounded,
          title: 'Settings',
          description: 'Playback, Danmaku, Appearance & Rules',
...
class _CollectHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String caption = lastWatchTime == null
        ? 'Anime you collect will be listed here'
        : 'Last watched ${formatTimestampToRelativeTime(lastWatchTime.millisecondsSinceEpoch ~/ 1000)}';
