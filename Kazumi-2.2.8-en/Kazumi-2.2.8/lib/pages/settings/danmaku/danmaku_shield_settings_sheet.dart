      ...
      body: Column(
        children: [
          MaterialBottomSheetHeader(
            title: 'Danmaku Filter',
            description: 'Filter danmaku using keywords or regular expressions',
            ...
            child: ListView(
              ...
              children: [
                MaterialBottomSheetSection(
                  ...
                  description: 'Starting and ending with "/" will be treated as a regular expression, e.g. "/\\d+/" blocks all digits',
                ...
                Observer(builder: (context) {
                  return MaterialBottomSheetSection(
                    title: 'Added ${myController.shieldList.length} keyword(s)',
