...
class _VideoDetailsSheetState extends State<VideoDetailsSheet>
  ...
  void _copyToClipboard(BuildContext context, String value) {
    ...
    KazumiDialog.showToast(message: 'Copied to Clipboard', context: context);
  }
          ...
          children: [
            if (compact)
              ...
              MaterialBottomSheetHeader(
                title: 'Video Details',
                description: 'Real-time playback status and diagnostic info',
                trailing: Row(
      ...
      return SettingsList(
        sections: [
          SettingsSection(
            ...
            tiles: [
              _statusTile(
                  Icons.link_rounded, 'Media URL', playerController.videoUrl),
              _statusTile(
                  Icons.playlist_play_rounded, 'Playlist', debug.playerPlaylist),
            ],
          ),
          SettingsSection(
            title: const Text('Video'),
            tiles: [
              _statusTile(Icons.aspect_ratio_rounded, 'Resolution', resolution),
              _statusTile(Icons.tune_rounded, 'Video Parameters', debug.playerVideoParams),
              _statusTile(
                  Icons.video_file_rounded, 'Video Track', debug.playerVideoTracks),
              _statusTile(
                  Icons.speed_rounded, 'Video Bitrate', debug.playerVideoBitrate),
            ],
          ),
          SettingsSection(
            ...
            tiles: [
              _statusTile(
                  Icons.graphic_eq_rounded, 'Audio Parameters', debug.playerAudioParams),
              _statusTile(
                  Icons.audio_file_rounded, 'Audio Track', debug.playerAudioTracks),
              _statusTile(
                  Icons.speed_rounded, 'Audio Bitrate', debug.playerAudioBitrate),
            ],
          ),
        ],
      );
  ...
  Widget _statusTile(IconData icon, String label, String value) {
    return SettingsTile(
      leading: icon,
      title: Text(label),
      description: Text(value.isEmpty ? 'No data yet' : value),
