...
class _ImageSearchPageState extends State<ImageSearchPage> {
  ...
  Future<void> _startSearch() async {
    if (_isUrlMode) {
      ...
      if (imageUrl.isEmpty || uri == null || !uri.hasScheme) {
        KazumiDialog.showToast(message: 'Please enter a valid image link');
        return;
      }
              ...
              children: [
                ...
                Center(
                  child: TextButton.icon(
                    ...
                    label: Text(_isUrlMode ? 'Upload an Image File Instead' : 'Enter an Image URL Instead'),
                  ),
                ),
                Observer(
      ...
      children: [
        TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Please enter an image link',
            hintStyle: TextStyle(
          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Preview after entering an image link',
                    style: textTheme.bodySmall?.copyWith(
                      color:
              ...
              errorBuilder: (context, error, stackTrace) => Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Please check whether the link is valid',
                      style: textTheme.bodySmall?.copyWith(
                        color: colorScheme.onSurfaceVariant,
                      ),
                    ),
      ...
      builder: (context) {
        ...
        if (results.isEmpty) {
          return _buildStateCard(
            ...
            title: errorMessage.isEmpty ? 'Search results will be shown here' : 'No search results obtained',
            description:
                errorMessage.isEmpty ? 'Select an image file or enter an image link to start searching' : errorMessage,
          );
        }
  ...
  Widget _buildTips(ColorScheme colorScheme, TextTheme textTheme) {
    ...
    final tips = <Widget>[
      Text('Only original-aspect-ratio anime screenshots are supported for search results', style: baseStyle),
