...
class _InfoPageState extends State<InfoPage> with TickerProviderStateMixin {
  ...
  void onBangumiRatingTap() {
    ...
    if (token.isEmpty) {
      KazumiDialog.showToast(message: 'Please bind your Bangumi account in sync settings before posting a comment');
      return;
    }
    final localType = infoController.collectController
        .getCollectType(infoController.bangumiItem);
    if (localType == 0) {
      KazumiDialog.showToast(message: 'Please track this anime before posting a review');
      return;
    }
    KazumiDialog.show(
        ...
        child: Scaffold(
          ...
          floatingActionButton: showRatingFab
              ? FloatingActionButton.extended(
                  ...
                  label: const Text('Post a Comment'),
