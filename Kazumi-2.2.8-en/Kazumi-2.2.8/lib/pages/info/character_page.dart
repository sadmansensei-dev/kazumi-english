...
const Set<String> _hiddenInfoKeys = {'Sources'};
...
class _CharacterPageState extends State<CharacterPage> {
  ...
  String get _headerTitle {
    ...
    return name.isEmpty ? 'Characters' : name;
  }

  String? get _headerDescription {
    final relation = widget.characterRelation.trim();
    if (relation.isEmpty || relation == 'Unknown') return null;
    return relation;
  }
  ...
  Widget _buildDetails(BuildContext context, CharacterFullItem character) {
    ...
    if (character.summary.trim().isNotEmpty) {
      blocks.add(
        CharacterInfoField(key: 'Synopsis', value: character.summary.trim()),
      );
    }
