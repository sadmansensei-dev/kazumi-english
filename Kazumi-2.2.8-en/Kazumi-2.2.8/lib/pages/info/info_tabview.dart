                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: Text(fullIntro ? 'Load Less' : 'Load More'),
                      ),
                    ],
                  );
                } else {
    ...
    return Builder(
      builder: (BuildContext context) {
        return CustomScrollView(
          ...
          key: const PageStorageKey<String>('Related'),
          slivers: <Widget>[
              ...
              builder: (context, constraints) {
                if (widget.relationsQueryTimeout) {
                  return SliverFillRemaining(
                    ...
                    child: GeneralErrorWidget(
                      errMsg: 'Failed to get related items, please retry',
                      actions: [
                        GeneralErrorButton(
                ...
                if (widget.relationsHasLoaded && widget.relationList.isEmpty) {
                  return const SliverFillRemaining(
                    hasScrollBody: false,
                    child: Center(child: Text('No related items yet')),
                  );
                }
            ...
            slivers: <Widget>[
              ...
              SliverLayoutBuilder(builder: (context, _) {
                ...
                if (widget.commentsQueryTimeout) {
                  return SliverFillRemaining(
                    child: GeneralErrorWidget(
                      errMsg: 'Failed to fetch, please retry',
                      actions: [
                        GeneralErrorButton(
                          onPressed: () {
...
class _RelatedBangumiCardH extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final relationLabel = relation.relation.isEmpty ? 'Related' : relation.relation;
